...
export default function Store() {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Floating WhatsApp Support Button (Deactivated)
            <a href="https://wa.me/258850741435" className="whatsapp-float" target="_blank" rel="noopener noreferrer" title="Suporte no WhatsApp">
