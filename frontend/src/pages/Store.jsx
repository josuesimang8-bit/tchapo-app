...
const isFuzzyTokenMatch = (token, targetWord) => {
...
const calcProductSearchScore = (product, query) => {
...
function getCategoryIcon(cat) {
    ...
    if (c.includes('smart') || c.includes('telem') || c.includes('celular') || c.includes('phone') || c.includes('iphone') || c.includes('android')) return (
    ...
    if (c.includes('áudio') || c.includes('audio') || c.includes('som') || c.includes('fone') || c.includes('airpod') || c.includes('coluna') || c.includes('speaker')) return (
    ...
    if (c.includes('wear') || c.includes('reló') || c.includes('watch') || c.includes('smartwatch')) return (
    ...
    if (c.includes('jogo') || c.includes('game') || c.includes('gaming') || c.includes('consola') || c.includes('joystick') || c.includes('playstation')) return (
...
export default function Store() {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <a href="https://wa.me/258859272314?text=Ol%C3%A1%2C%20preciso%20de%20ajuda%20com%20a%20minha%20compra%20na%20Tchapo%20Tchapo" className="whatsapp-float" target="_blank" rel="noopener noreferrer" title="Suporte no WhatsApp">
